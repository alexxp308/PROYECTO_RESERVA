        ...
        success: function (response) {
            if (response.length > 0) {
                ...
                for (var j = 0; j < data.length; j++) {
                    ...
                    str += "<td align='center'><button type='button' class='btn btn-primary btn-sm' onclick='editarCampaña(" + fila[0] + "," + "\"" + fila[1] + "\")'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></button></td>";
                    str += "</tr>";
                }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length > 0) {
                    ...
                    str += "<td align='center'><button type='button' class='btn btn-primary btn-sm' onclick='editarCampaña(" + datos[0] + "," + "\"" + datos[1] + "\")'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></button></td>";
                    str += "</tr>";
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length > 0) {
                    ...
                    columna[1].innerHTML = "<button type='button' class='btn btn-primary btn-sm' onclick='editarCampaña(" + datos[0] + "," + "\"" + datos[1] + "\")'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></button>";
                    $("#dvCampañas").modal("hide");
                } else {
